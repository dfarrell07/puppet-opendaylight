...
class opendaylight::params {
  ...
  $odl_rest_port = '8080'
  $install_method = 'rpm'
  $tarball_url = 'https://nexus.opendaylight.org/content/repositories/staging/org/opendaylight/integration/distribution-karaf/0.4.0-RC2.1/distribution-karaf-0.4.0-RC2.1.tar.gz'
